...
*   **Expected Verdict**: `SKIP` → ⚠️ **BORDERLINE — cần review thủ công**
*   **Lý do ban đầu**: Mặt hàng đồ ăn đặc sản nội địa Trung Quốc rất khó tìm được link affiliate tương đương hoặc chất lượng đảm bảo trên sàn VN. Vấn đề vệ sinh an toàn thực phẩm cũng là một rủi ro (risks) khi làm affiliate.
*   **Live eval (2026-05-17)**: Model trả về `PROCEED` (score 72, confidence 78) với lập luận rằng bún ốc Liễu Châu đã có sản phẩm đóng gói bán trên Shopee/Lazada VN, engagement rate ~9.6% cao, và format "thử thách mùi nồng" hợp trend gen Z Việt. Lập luận có căn cứ — **không coi là fail rõ ràng**. Case này nên được người review thủ công quyết định label cuối.
```json
{
