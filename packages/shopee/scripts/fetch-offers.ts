...
/**
 * 🚫 DEPRECATED — Legacy Shopee storage_state fetch flow.
 *
 * Depends on .secrets/shopee_storage_state.json produced by `pnpm shopee:login`
 * (also DEPRECATED). Replaced by CDP targeted-click flow (Round 26B+):
